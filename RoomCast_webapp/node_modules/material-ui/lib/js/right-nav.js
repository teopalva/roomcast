...
var RightNav = React.createClass({displayName: "RightNav",
  ...
  render: function() {
    ...
    if (this.state.modal) overlay = React.createElement(Overlay, {show: this.state.open, onTouchTap: this._onOverlayBlockTouchTap});
