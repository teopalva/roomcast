...
*/
  &.mui-is-save-button {
    ...
    .mui-raised-button-container {
      background-color: @raised-button-save-button-color;

      .mui-raised-button-ripple {
        &.mui-is-visible {
          .ripple-click-alt(
          @animation-name: raised-button-save-button-ripple-click;
          @color: @raised-button-save-button-ripple-color;
          )
        }
      }

      &.mui-is-keyboard-focused {
        background-color: @raised-button-save-button-hover-color;

        .mui-raised-button-focus-ripple {
          background-color: @raised-button-save-button-focus-ripple-color;
        }
      }
    }
    ...
    .mui-raised-button-label {
      color: @raised-button-save-button-text-color;
    }
  ...
  &.mui-is-undo-button {
    ...
    .mui-raised-button-container {
      background-color: @raised-button-undo-button-color;

      .mui-raised-button-ripple {
        &.mui-is-visible {
          .ripple-click-alt(
          @animation-name: raised-button-undo-button-ripple-click;
          @color: @raised-button-undo-button-ripple-color;
          )
        }
      }

      &.mui-is-keyboard-focused {
        background-color: @raised-button-undo-button-hover-color;

        .mui-raised-button-focus-ripple {
          background-color: @raised-button-undo-button-focus-ripple-color;
        }
      }
    }
    ...
    .mui-raised-button-label {
      color: @raised-button-undo-button-text-color;
    }
