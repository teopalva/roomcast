...
//App Colors
@primary-1-color: @cyan-500; //@cyan-500;
@primary-2-color: @pink-500;  //@cyan-700;
@primary-3-color: @pink-500;  // undo button
@accent-1-color: @cyan-500; // save button
@accent-2-color: @pink-400;
...
@flat-button-primary-hover-color: lighten(@primary-2-color, 42%);
@flat-button-primary-text-color: @primary-2-color;
...
@flat-button-secondary-hover-color: lighten(@primary-1-color, 50%);
@flat-button-secondary-text-color: @primary-1-color;
@flat-button-secondary-ripple-color: fade(darken(@flat-button-secondary-text-color, 20%), 10%);
@flat-button-secondary-focus-ripple-color: fade(@flat-button-secondary-ripple-color, 7%);
...
@raised-button-primary-color: @primary-2-color;
@raised-button-primary-hover-color: darken(@primary-2-color, 15%);
...
@raised-button-secondary-ripple-color: fade(@black, 15%);
...
/////////// Custom
@raised-button-save-button-color: @accent-1-color;
@raised-button-save-button-hover-color: darken(@accent-1-color, 4%);
@raised-button-save-button-text-color: @white;
@raised-button-save-button-ripple-color: fade(@black, 15%);
@raised-button-save-button-focus-ripple-color: @raised-button-save-button-ripple-color;
@raised-button-undo-button-color: @primary-3-color;
@raised-button-undo-button-hover-color: darken(@primary-3-color, 4%);
@raised-button-undo-button-text-color: @white;
@raised-button-undo-button-ripple-color: fade(@black, 15%);
@raised-button-undo-button-focus-ripple-color: @raised-button-undo-button-ripple-color;
///////////

@floating-action-button-size: 56px;
@floating-action-button-mini-size: 40px;
@floating-action-button-color: @primary-2-color;
